          ...
          <div className="education-content-box">
            ...
            <div className="education-box">
              ...
              <div className="cert-link-box">
                <h3>Acheivement: </h3>
                <a href="https://sites.google.com/view/mark-treehouse-tech-degree" className="cert-link-style" rel="noreferrer" target="_blank">View Tech Degree</a>
              </div>
            ...
            <div className="education-box">
              ...
              <div className="cert-link-box">
                <h3>Acheivement: </h3>
                <a href="https://sites.google.com/view/mark-javascript" className="cert-link-style" rel="noreferrer" target="_blank">View Certificate</a>
              </div>
            ...
            <div className="education-box">
              ...
              <div className="cert-link-box">
                <h3>Acheivement: </h3>
                <a href="https://sites.google.com/view/markwisdomreeves" className="cert-link-style" rel="noreferrer" target="_blank">View Certificate</a>
              </div>
              <a href="https://www.freecodecamp.org" className="tech-school-link" rel="noreferrer" target="_blank">Free Code Camp</a>
